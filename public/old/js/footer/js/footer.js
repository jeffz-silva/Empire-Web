...
(function () {
   ...
   footerContent ='<div class="footerWrap"><div class="footer screenCenter"><a class="footerLogo"href="http://#/"target="_blank"></a><div class="footerNav"><p class="wenww">'+footerWww+'</p><p>DDtank Empire <em>Versão 3.6.5</em></p><div class="footerTips">Servidor Privado<br>Copyright © 2018 DDtank Empire. Todos os direitos reservados.</div></div><a href="'+rfidHref+'" class="game_rfid" style="display:'+rfidShow+'" target="_blank">&#160;</a></div></div>'
