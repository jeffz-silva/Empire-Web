...
<root>
    <config>
        <BACKUP_FLASHSITE value="{{ $GameInfo->Flash }}" />
        <USE_MD5 value="false" />
        <FLASHSITE value="{{ $GameInfo->Flash }}" />
        <SITE value="{{ $GameInfo->Resource }}" />
        <FIRSTPAGE value="{{ Route('web.app.home') }}/" />
        <REGISTER value="{{ Route('web.app.home') }}/" />
        <REQUEST_PATH value="{{ $GameInfo->Quest }}" />
        <LOGIN_PATH value="{{ Route('web.app.home') }}/" />
        <FILL_PATH value="{{ Route('web.app.home') }}/" />
        <POLICY_FILES>
            <file value="{{ Route('web.app.home') }}/crossdomain.xml" />
        </POLICY_FILES>
        ...
        <LANGUAGE value="{{ $GameInfo->Language }}" />
        <PARTER_ID value="316" />
    ...
    <update>
        <version from="605" to="607">
            <file value="flash/2.png" />
            <file value="2.png" />
            <file value="ui/spain/language.txt" />
            <file value="ui/spain/xml/xml.png" />
            <file value="ui/spain/swf/avatarcollection.swf" />
            <file value="ui/spain/swf/totem.swf" />
        </version>
    </update>
</root>
